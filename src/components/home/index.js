...
import "./index.css"
import BannerImg from '../../assets/images/bg_1.jpg';
function Homepage() {
	return (
		<>
					...
					<div class="slider-item js-fullheight">
						...
						<div class="container-fluid p-0">
							<div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
								<img class="one-third order-md-last img-fluid banner-img" src={BannerImg} width="120" />
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product d-flex flex-column">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/choose-1.jpg" alt="Colorlib Template" />
    						<div class="overlay"></div>
    					</a>
			...
			<section class="ftco-section ftco-choose ftco-no-pb ftco-no-pt">
				<div class="container">
					<div class="row no-gutters">
						<div class="col-lg-4">
							<div class="choose-wrap divider-one img p-5 d-flex align-items-end" style={{ backgroundImage: `url('images/choose-1.jpg')` }}>
						...
						<div class="col-lg-8">
							<div class="row no-gutters choose-wrap divider-two align-items-stretch">
								<div class="col-md-12">
									<div class="choose-wrap full-wrap img align-self-stretch d-flex align-item-center justify-content-end" style={{ backgroundImage: `url('images/choose-1.jpg')` }}>
								...
								<div class="col-md-12">
									<div class="row no-gutters">
										...
										<div class="col-md-6">
											<div class="choose-wrap wrap img align-self-stretch d-flex align-items-center" style={{ backgroundImage: `url('images/choose-1.jpg')` }}>
			...
			<section class="ftco-section ftco-deal bg-primary">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<img src="images/choose-1.jpg" class="img-fluid" alt="" />
						</div>
						<div class="col-md-6">
							...
							<div class="text-deal">
								...
								<ul class="thumb-deal d-flex mt-4">
									<li class="img" style={{ backgroundImage: `url('images/choose-1.jpg')` }}></li>
									<li class="img" style={{ backgroundImage: `url('images/choose-1.jpg')` }}></li>
									<li class="img" style={{ backgroundImage: `url('images/choose-1.jpg')` }}></li>
								</ul>
							</div>
							...
							<div class="carousel-testimony owl-carousel">
								<div class="item">
									<div class="testimony-wrap">
										<div class="user-img mb-4" style={{ backgroundImage: `url('images/choose-1.jpg')` }}>
				...
				<div class="container-fluid px-0">
					<div class="row no-gutters">
						<div class="col-md-4 col-lg-2 ftco-animate">
							<a href="images/choose-1.jpg" class="gallery image-popup img d-flex align-items-center" style={{ backgroundImage: `url('images/choose-1.jpg')` }}>
